...
import "./VideoMainSection.styles.scss";
  ...
  return (
    <main className="video">
      ...
      <div className="video__info-block">
        <div className="video__name-block">
          <h1 className="video__name">
            Dude You Re&nbsp;Getting A&nbsp;Telescope
          </h1>
          <button className="video__drop-button" type="button">
            <svg
              width="10"
              height="7"
              viewBox="0 0 10 7"
        ...
        <div className="video__info">
          ...
          <div className="video__info-additional">
            <div className="video__info-additional-block">
              <button className="video__info-button">
                <svg
                  width="14"
                  height="13"
                  viewBox="0 0 14 13"
                ...
                <span className="video__info-text">123k</span>
              </button>
              <button className="video__info-button">
                <svg
                  width="14"
                ...
                <span className="video__info-text">435k</span>
              </button>
              <button className="video__info-button">
                <svg
                  width="14"
                ...
                <span className="video__info-text" id="share">
                  Share
                </span>
              </button>
            </div>
