...
function VideoPlayer() {
  return (
    <div className="player">
      ...
      />
      <div className="player__pannel">
        <div className="player__pannel-wrapper player__pannel-wrapper--desktop">
          <div className="time">
            <span className="time-value">1:34</span>
            <span className="time-value">19:00</span>
          </div>
          <div className="timeline">
            <div className="timeline timeline--value"></div>
          </div>
          {/*<input type="range" className="timeline-range" />*/}
          <div className="player__controls">
            <div className="player__controls-main">
              <button className="player__controls-button">
                <svg
                  width="22"
                  height="24"
                  viewBox="0 0 22 24"
              ...
              <button className="player__controls-button volume">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <div className="volume__line">
                  <div className="volume__line volume__value"></div>
                </div>
              </button>
            </div>
        ...
        <div className="player__pannel-wrapper player__pannel-wrapper--mobile">
          <div className="time">
            <button className="player__controls-button">
              <svg
                width="22"
            ...
            <div className="time-value-block">
              <span className="time-value">1:34</span>
              <div className="timeline">
                <div className="timeline timeline--value"></div>
              </div>
            ...
            <button className="player__controls-button volume">
              ...
              <div className="volume__value"></div>
            </button>
          </div>
        </div>
      </div>
