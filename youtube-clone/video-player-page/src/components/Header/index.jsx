...
import SearchBlock from "../SearchBlock/index.jsx";
    ...
    <header className="header">
      ...
      <a className="home-link">
        <img
          ...
          alt="Youtube logo to return to main page"
        />
      </a>
      <div className="header__controls-wrapper">
        ...
        <div className="header__controls">
          <button
            className="header__controls-btn header__controls-btn--mobile"
            type="button"
          >
            <svg
          ...
          <button className="header__controls-btn header__controls-btn--mobile">
            <img
              src="../../../public/userpic.jpg"
              alt="User account picture"
              className="userpic"
            />
          </button>
          <button className="header__controls-btn full-menu" type="button">
            <svg
              width="5"
              height="19"
              viewBox="0 0 5 19"
